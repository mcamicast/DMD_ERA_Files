...
0.1  111  105 0.001 0.1  6    0.01; %apply three phase fault at bus 111, on line 111-105
0.15 0    0    0    0    0    0.01; %clear fault at bus 111
0.20 0    0    0    0    0    0.01; %clear remote end
0.50 0    0    0    0    0    0.01; % increase time step 
1.0  0    0    0    0    0    0.01; % increase time step
60.0  0    0    0    0    0    0]; % end simulation


tol = 1e-8;   % tolerance for convergence
iter_max = 30; % maximum number of iterations
acc = 1.0;   % acceleration factor
% [~,~,~] = loadflow(bus,line,tol,iter_max,acc,'y',1);
