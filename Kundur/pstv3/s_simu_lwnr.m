...
basdat = {'100','60'};% inputdlg({'Base MVA:','Base Frequency Hz:'},'Input Base Data',1,{'100','60'}); 
...
lfs = {'y'}; % inputdlg('Do you want to solve loadflow > (y/n)[y] ','s');
...
% pnts_lwnr=[0.1:3/30:3]; % pnts_lwnr=[0.1:2/8:1.6 2:1/2:3]'
recordlwnr.(genvarname(['mlwnr_m1_bvr_f' num2str(lwnri)]))=[t' mac_spd' abs(bus_v(1:end-1,:))' exc_sig' pm_sig']; % exc_sig
end
save d48_m1_bvr_10 recordlwnr -v7.3
