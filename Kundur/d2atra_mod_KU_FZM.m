...
%  5	maximum power order  Tmax	pu on gen
% erator base
...
0.5  101  3    0    0    7    0.01; % 3 ph fault %add option 7, clear fault without loss of line
0.5+5*0.01  0    0    0    0    0    0.01; %clear remote end
