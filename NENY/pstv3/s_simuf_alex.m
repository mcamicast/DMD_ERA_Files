function [sstr] = s_simuf_alex(dfile,pathname,sys_freq_i,basmva_i)
% s_simu.m  
...
clearvars -global -except maqui_num frec ttt amplitud fase Mag_bus
...
%%
%Linea para observar la magnitud de los voltajes de salida
Mag_bus=abs(bus_v);
%%
...
%Magnitud voltaje de salida
sstr.Mag_bus =Mag_bus;
%%
